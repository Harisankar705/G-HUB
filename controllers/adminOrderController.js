        ...
        try {
            ...
            else 
            {
                ...
                if(status==="Delivered")
                {
                    ...
                    for(const productInfo of orderData.products)
                    {
                        productInfo.orderStatus="Delivered",
                        await productInfo.save()
                    }
                }
...
adminOrderController.allowReturn=async(req,res)=>{
    ...
    const allProductsReturned=orderDetails.products.every(product=>product.orderStatus==="Return Accepted")
...
console.log("IN DECLINERETURN")
    ...
    await order.save()
    const allProductsReturned=order.products.every(product=>product.orderStatus==="Request Declined")
    if(allProductsReturned)
    {
